...
export const Filiere = (props: IFiliereProps) => {
  useEffect(() => {
    props.getEntities();
  }, []);

  const { filiereList, match, loading } = props;
  return (
    <div>
      <h2 id="filiere-heading">
        <Translate contentKey="intranetApp.filiere.home.title">Filieres</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="intranetApp.filiere.home.createLabel">Create new Filiere</Translate>
        </Link>
      </h2>
        ...
        {filiereList && filiereList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="intranetApp.filiere.home.notFound">No Filieres found</Translate>
            </div>
          )
        )}
      </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Filiere);
